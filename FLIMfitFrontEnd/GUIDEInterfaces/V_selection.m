function varargout = V_selection(varargin)
% V_SELECTION MATLAB code for V_selection.fig
%      V_SELECTION, by itself, creates a new V_SELECTION or raises the existing
%      singleton*.
%
%      H = V_SELECTION returns the handle to a new V_SELECTION or the handle to
%      the existing singleton*.
%
%      V_SELECTION('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in V_SELECTION.M with the given input arguments.
%
%      V_SELECTION('Property','Value',...) creates a new V_SELECTION or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before V_selection_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to V_selection_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help V_selection

% Last Modified by GUIDE v2.5 21-Oct-2013 12:26:46

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @V_selection_OpeningFcn, ...
                   'gui_OutputFcn',  @V_selection_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before V_selection is made visible.
function V_selection_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to V_selection (see VARARGIN)

% Choose default command line output for V_selection
...
% UIWAIT makes V_selection wait for user response (see UIRESUME)
...
function varargout = V_selection_OutputFcn(hObject, eventdata, handles) 
